...
/* Heap (select heap_4 via CMake: FREERTOS_HEAP=4) */
...
/* NVIC priority model (STM32G4 = 4 bits) */
#ifndef __NVIC_PRIO_BITS
  #define __NVIC_PRIO_BITS                    4
#endif
#define configKERNEL_INTERRUPT_PRIORITY       ( ( (1U<<__NVIC_PRIO_BITS)-1U ) << (8U-__NVIC_PRIO_BITS) )
#define configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY 5
#define configMAX_SYSCALL_INTERRUPT_PRIORITY  ( (uint32_t)( configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY << (8U-__NVIC_PRIO_BITS) ) )
